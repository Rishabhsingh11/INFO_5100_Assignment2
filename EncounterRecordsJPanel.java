...
public class EncounterRecordsJPanel extends javax.swing.JPanel {
    ...
    DoctorDirectory doctoredirectory;
    PatientDirectory patientdirectory;
    String PID;
    EncounterDirectory encounterDirectory;
    public EncounterRecordsJPanel(PersonDirectory persondirectory, DoctorDirectory doctoredirectory, PatientDirectory patientdirectory, HospitalDirectory hospitaldirectory, String PID, EncounterDirectory encounterdirectory) {
        initComponents();
        this.persondirectory = persondirectory;
        this.hospitaldirectory = hospitaldirectory;
        this.doctoredirectory = doctoredirectory;
        this.patientdirectory = patientdirectory;
        this.encounterDirectory = encounterdirectory;
        for(Patient selectedSignUp : patientdirectory.getPatientDirectory()){
            if (String.valueOf(selectedSignUp.getPatient_id()).equals(PID)){
            txtPatientID.setText(String.valueOf(selectedSignUp.getPatient_id()));
            txtPatientName.setText(String.valueOf(selectedSignUp.getName())); 
            }
        }
        populateTable();
    }
    ...
    private void initComponents() {
        ...
        tblEncounterDirectory.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Encounter ID", "Patient ID", "Hospital's Name", "Doctor's Name", "Date", "TimeStamp"
            }
        ) {
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        Encounter selectedSignUp = (Encounter) model.getValueAt(selectedRowIndex,2);
        
        txtEncounterID.setText(String.valueOf(selectedSignUp.getEncounterid()));
        txtHospitalName.setText(String.valueOf(selectedSignUp.getHospital_Name()));
        txtDoctorName.setText(String.valueOf(selectedSignUp.getDoctor_Name()));
        txtDate.setText(String.valueOf(selectedSignUp.getEncounter_date()));
        txtTimeStamp.setText(String.valueOf(selectedSignUp.getEncounter_time()));
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        DefaultTableModel model = (DefaultTableModel) tblEncounterDirectory.getModel();
        Encounter su = (Encounter) model.getValueAt(tblEncounterDirectory.getSelectedRow(), 2);
        ...
        if (tblEncounterDirectory.getSelectedRowCount()==1) {
            ...
            su.setEncounter_date(Date);
            su.setEncounter_time(TimeStamp);
    ...
    private void populateTable() {
        ...
        for (Encounter su : encounterDirectory.getEncounterDirectory()){
            ...
            row[0] = su.getEncounterid();
            row[1] = su.getPatientid();
            row[2] = su;
            row[3] = su.getHospital_Name();
            row[4] = su.getEncounter_date();
            row[5] = su.getEncounter_time();
