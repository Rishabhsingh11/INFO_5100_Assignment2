...
public class NewPatientEncounterJPanel extends javax.swing.JPanel {
    ...
    public NewPatientEncounterJPanel(PersonDirectory persondirectory,HospitalDirectory hospitaldirectory,DoctorDirectory doctordirectory,String PID,PatientDirectory patientdirectory,EncounterDirectory encounterdirectory) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tblDoctorDirectory.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Hospital Name", "Hospital ID", "DoctorID", "Doctor's Name", "Age", "City", "State"
            }
        ) {
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        long PatientID = Integer.parseInt(txtPatientID.getText());
        ...
        Encounter e = encounterdirectory.addEncounter();

        e.setPatientid(PatientID);
        e.setHospital_Name(HospitalName);
        e.setDoctor_Name(DoctorName);
        e.setEncounter_date(Date);
        e.setEncounter_time(TimeStamp);
    ...
    private void btnFetchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFetchActionPerformed
        ...
        txtDoctorID.setText(String.valueOf(selectedSignUp.getDoctor_id()));
    ...
    private void populateTable() {
        ...
        for(Doctor su : doctordirectory.getDoctorDirectory())
        {
            ...
            row[0] = su.getHospital_name();
            row[1] = su.getHospital_id();
            row[2] = su.getDoctor_id();
            row[3] = su;
            row[4] = su.getAge();
            row[5] = su.getCity();
            row[6] = su.getState();
